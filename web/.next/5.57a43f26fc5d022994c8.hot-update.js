...
var _default = function (_React$Component) {
  ...
  _createClass(_default, [{
    ...
    value: function render() {
      ...
      var gLineData = [['Time Diff', 'Height 0', 'Height 1']];
      ...
      var _loop2 = function _loop2(_i) {
        ...
        .filter(function (item) {
          return item.block.adopted > _this3.state.slider.value + _i * 50;
        }).filter(function (item) {
          return item.block.adopted <= _this3.state.slider.value + (_i + 1) * 50;
        }).map(function (item, index) {
          blocksQty += 1;
        });
...
//# sourceMappingURL=5.57a43f26fc5d022994c8.hot-update.js.map