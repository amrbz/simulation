        ...
        var _loop2 = function _loop2(_i) {
          ...
          var _loop3 = function _loop3(j) {
            ...
            _this3.state.blocks.list.filter(function (item) {
              ...
              return item.block.adopted > _this3.state.slider.min + j * 10;
            }).filter(function (item) {
              return item.block.adopted <= _this3.state.slider.min + (j + 1) * 10;
            }).map(function (item, index) {
              blocksQty += 1;
            });
...
//# sourceMappingURL=5.dfea59551e1d29f3ecd5.hot-update.js.map