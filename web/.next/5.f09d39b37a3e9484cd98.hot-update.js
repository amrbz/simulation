    ...
    value: function render() {
      ...
      if (this.state.adoptions.list) {
        var _loop2 = function _loop2(_i) {
          var blocksQty = 0;
          console.log('log', _this3.state.adoptions.list[_i]);

          var _loop3 = function _loop3(j) {
            var row = [j * 10];
            _this3.state.blocks.list.filter(function (item) {
              return item.block.adopted >= _this3.state.adoptions.list[_i];
            }).filter(function (item) {
              return item.block.adopted > _this3.state.slider.value + j * 10;
            }).filter(function (item) {
              return item.block.adopted <= _this3.state.slider.value + (j + 1) * 10;
            }).map(function (item, index) {
              blocksQty += 1;
            });
          ...
          for (var j = 0; j < _this3.state.maxLocalDiff / 10; j += 1) {
            _loop3(j);
          }
        };
...
//# sourceMappingURL=5.f09d39b37a3e9484cd98.hot-update.js.map