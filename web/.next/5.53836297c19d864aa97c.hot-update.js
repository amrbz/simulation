        ...
        for (var _i = 0; _i < this.state.adoptions.list.length; _i += 1) {
          ...
          var _loop2 = function _loop2(j) {
            ...
            _this3.state.blocks.list.filter(function (item) {
              return item.block.adopted >= _this3.state.adoptions.list[j];
          ...
          for (var j = 0; j < this.state.maxLocalDiff / 10; j += 1) {
            _loop2(j);
          }
        }
      }
...
//# sourceMappingURL=5.53836297c19d864aa97c.hot-update.js.map